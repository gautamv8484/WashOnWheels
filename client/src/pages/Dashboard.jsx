...
const Dashboard = () => {
  ...
  const { user, logout, isAuthenticated, getMyBookings, getMySubscriptions } = useAuth()
  ...
  const getPlanDetails = (plan) => {
    const plans = {
      basic: {
        ...
        color: '#64748b',
        name: 'Basic Plan',
        features: ['Alternate day wash', 'Exterior only']
      },
      premium: {
        icon: <FaCrown />,
        color: '#D97706',
        name: 'Premium Plan',
        features: ['Daily wash', 'Interior 2x/month', 'Wax 1x/month']
      },
      business: {
        icon: <FaRocket />,
        color: '#4F46E5',
        name: 'Business Plan',
        features: ['Up to 5 cars', 'Full detailing', 'Dedicated manager']
      }
    }
  ...
  const handleRenew = async (sub) => {
    try {
      ...
      await axios.post(
        `${API}/subscriptions/${sub._id}/renew`,
        {},
  ...
  if (loading) {
    return (
      <div style={{
        ...
        alignItems: 'center', minHeight: '100vh', paddingTop: '80px'
      }}>
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button onClick={handleLogout} style={{
              display: 'flex', alignItems: 'center', gap: '8px',
              padding: '12px 24px', background: '#FEE2E2',
        ...
        <div style={{
          ...
          marginBottom: '25px', overflowX: 'auto'
        }}>
          {[
        ...
        {activeTab === 'overview' && (
          <>
            ...
            {activeSub && (
              ...
              >
                <div style={{
                  ...
                  <div>
                    <div style={{
                      ...
                      <h3 style={{ margin: 0, fontSize: '1.5rem' }}>
                        {getPlanDetails(activeSub.plan).name}
                      </h3>
                    </div>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '3rem', fontWeight: '800' }}>
                      {getDaysRemaining(activeSub.endDate)}
                    </div>
                ...
                <div style={{ marginTop: '20px' }}>
                  <div style={{
                    display: 'flex', justifyContent: 'space-between',
                    fontSize: '0.85rem', opacity: 0.9, marginBottom: '8px'
                  }}>
            ...
            {!activeSub && (
              ...
              >
                ...
                <p style={{ color: '#64748b', marginBottom: '20px' }}>
                  Subscribe to a plan and save more on regular washes!
                </p>
            ...
            <div style={{
              ...
              <div style={{
                display: 'flex', justifyContent: 'space-between',
                alignItems: 'center', padding: '20px 25px',
              ...
              {bookings.length > 0 ? (
                ...
                <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
                  <FaCalendarAlt style={{
                    fontSize: '2rem', marginBottom: '10px', opacity: 0.3
                  }} />
                  <p>No bookings yet</p>
                  <Link to="/booking" style={{ color: '#4F46E5', fontWeight: '600' }}>
          ...
          <div style={{
            ...
            {bookings.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <div style={{
                        display: 'flex', alignItems: 'center',
                        gap: '5px', color: '#64748b', fontSize: '0.9rem'
                      }}>
                        <FaCalendarAlt /> {formatDate(booking.date)}
                      </div>
                      <div style={{
                        display: 'flex', alignItems: 'center',
                        gap: '5px', color: '#64748b',
                    ...
                    <div style={{
                      display: 'flex', alignItems: 'center',
                      gap: '5px', color: '#64748b', fontSize: '0.85rem'
                    }}>
                      <FaMapMarkerAlt />
                    ...
                    <span style={{
                      ...
                      background: statusInfo.bg, color: statusInfo.color,
                      display: 'flex', alignItems: 'center',
                      gap: '5px', textTransform: 'capitalize'
                    }}>
                      {statusInfo.icon} {booking.status}
                    </span>
                  </motion.div>
              ...
              <div style={{ textAlign: 'center', padding: '60px', color: '#64748b' }}>
                <FaCalendarAlt style={{
                  fontSize: '3rem', marginBottom: '15px', opacity: 0.3
                }} />
                <h3>No Bookings Yet</h3>
                <p>Book your first car wash!</p>
                <Link to="/booking" style={{
                  display: 'inline-flex', alignItems: 'center', gap: '8px',
                  padding: '12px 25px', background: '#4F46E5',
                  color: 'white', borderRadius: '10px',
                  textDecoration: 'none', fontWeight: '600', marginTop: '15px'
                }}>
          ...
          <>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    overflow: 'hidden', marginBottom: '25px'
                  }}
                >
                  <div style={{
                    background: 'linear-gradient(135deg, #4F46E5, #7C3AED)',
                    ...
                    <div style={{
                      ...
                      <div>
                        ...
                        <p style={{ opacity: 0.9 }}>
                          ₹{sub.amount}/{sub.billingCycle || 'month'}
                        </p>
                      </div>
                      <div style={{
                        textAlign: 'center',
                        ...
                        <motion.div
                          ...
                          style={{
                            ...
                            background: daysLeft <= 7
                              ? '#EF4444'
                              : daysLeft <= 15 ? '#F59E0B' : 'white'
                          }}
                        />
                      </div>
                      {daysLeft <= 7 && (
                        <p style={{
                          marginTop: '10px', fontSize: '0.9rem', color: '#FEF3C7'
                        }}>
                      ...
                      {[
                        {
                          ...
                          value: (
                            <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                              {getVehicleIcon(sub.vehicleType)}
                              {sub.vehicleType?.toUpperCase()} • {sub.vehicleNumber}
                            </span>
                          )
                        },
                        {
                          label: 'Preferred Time',
                          value: sub.preferredTime || 'Not set'
                        },
                        {
                          label: 'Services Done',
                          value: `${sub.servicesCompleted || 0} washes`
                        },
                        {
                          label: 'Auto-Renew',
                          value: sub.autoRenew ? '✅ Enabled' : '❌ Disabled',
                          color: sub.autoRenew ? '#10B981' : '#EF4444'
                        }
                      ].map((item, i) => (
                        <div key={i}>
                          <div style={{
                            fontSize: '0.85rem', color: '#64748b', marginBottom: '5px'
                          }}>
                            {item.label}
                          </div>
                          <div style={{
                            fontWeight: '600', color: item.color || '#1e293b'
                          }}>
                            {item.value}
                          </div>
                        </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
                        {planInfo.features.map((feature, i) => (
                          <span key={i} style={{
                            display: 'flex', alignItems: 'center',
                            gap: '5px', color: '#059669', fontSize: '0.9rem'
                          }}>
                            <FaCheck /> {feature}
                          </span>
                        ))}
                  ...
                  <div key={sub._id} style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                      ...
                      <button
                        ...
                        style={{
                          display: 'flex', alignItems: 'center', gap: '5px',
                          padding: '8px 15px', background: '#4F46E5',
            ...
            {subscriptions.length === 0 && (
              <div style={{
                ...
                <FaCrown style={{
                  fontSize: '4rem', color: '#e2e8f0', marginBottom: '20px'
                }} />
              ...
              <div style={{
                ...
                <button
                  ...
                  style={{
                    display: 'flex', alignItems: 'center', gap: '5px',
                    padding: '8px 16px',
                    background: editMode ? '#FEE2E2' : '#f1f5f9',
                  ...
                  <div key={field.name}>
                    ...
                    <input
                      ...
                      onChange={(e) => setProfileData({
                        ...profileData, [field.name]: e.target.value
                      })}
                      disabled={!editMode}
                      style={{
